...
#define device_ID_2   "60895a6ac54b6f1eb0aa60d7"
#define device_ID_3   "60895adad3827f1ea82d3578"
#define device_ID_4   "60895adad3827f1ea82d3578"
...
void startWebServer() {
  ...
  if (SETUP_MODE) {
    ...
    WEB_SERVER.on("/", []() {
      ...
      String localipStr = String(localip[0]) + '.' + String(localip[1]) + '.' + String(localip[2]) + '.' + String(localip[3]);
      String s = "<h1>IoT Button Status</h1>";
      s += "<h3>Network Details</h3>";
      s += "<p>Connected to: " + String(WiFi.SSID()) + "</p>";
      s += "<p>WIFI IP Address: " + localipStr + "</p>";
      s += "<p>ESP8266 IP Address: " + apipStr + "</p>";
    ...
    WEB_SERVER.on("/reset", []() {
      ...
      EEPROM.commit();
      String s = "<h1>Wi-Fi settings was reset.</h1><p>Reset device.</p>";
